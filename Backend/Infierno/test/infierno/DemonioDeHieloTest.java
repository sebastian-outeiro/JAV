...
public class DemonioDeHieloTest {

	private DemonioDeHielo unDemonio;
	
	@Before
	public void setup(){
		this.unDemonio = new DemonioDeHielo(50.0);
	}
	...
	@Test
	public void testNoPuedeCazarUnAlmaNoFriolenta() {
	...
	@Test
	public void testPuedeCazarUnAlmaConMenorPuntosDeBondadYFriolenta() {
		Alma unAlma = this.nuevaAlmaFriolenta(this.unDemonio.getNivelDeMaldad() - 10);
	...
	public void testPuedeAtormentarAUnAlma(){
		...
		Alma unAlma = this.nuevaAlmaNoFriolenta(bondadInicial);
